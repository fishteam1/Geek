 ...
 */
public abstract class LceFragment<V extends BaseContract.IView, P extends BaseContract.IPresenter<V>, M>
        extends MVPFragment<V, P> implements LceView<M> {
